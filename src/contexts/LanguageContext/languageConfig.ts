...
export const translations = {
  ar: {
    ...
    noAlternativesDescription: 'البدائل لهذه الفئة غير متوفرة بعد، هل تعرف بعض النصوص؟ تواصل بنا هنا',
  ...
  bn: {
    ...
    noAlternativesDescription: 'এই ক্যাটাগরির বিকল্প এখনও উপলব্ধ নয়, আপনি কিছু জানেন? এখানে আমাদের সাথে যোগাযোগ করুন',
    loading: 'লোড হচ্ছে...',
  ...
  en: {
    ...
    noAlternativesDescription: 'Alternatives for this category are not available yet. Do you know any? Text us here',
    loading: 'Loading...',
  ...
  es: {
    ...
    noAlternativesDescription: 'Aún no hay alternativas para esta categoría. ¿Conoces alguna? Envíanos un mensaje aquí',
    loading: 'Cargando...',
  ...
  fr: {
    ...
    noAlternativesDescription: 'Aucune alternative disponible pour cette catégorie. En connaissez-vous ? Envoyez-nous un message ici.',
    loading: 'Chargement...',
  ...
  id: {
    ...
    noAlternativesDescription: 'Alternatif untuk kategori ini belum tersedia. Apakah Anda tahu beberapa? Kirimkan pesan kepada kami di sini.',
    loading: 'Memuat...',
  ...
  tr: {
    ...
    noAlternativesDescription: 'Bu kategori için alternatifler henüz mevcut değil. Bazılarını biliyor musunuz? Buraya mesaj gönderin',
    loading: 'Yükleniyor...',
  ...
  ur: {
    ...
    noAlternativesDescription: 'اس زمرے کے لیے متبادل ابھی دستیاب نہیں ہیں، کیا آپ جانتے ہیں؟ یہاں ہمیں پیغام بھیجیں',
