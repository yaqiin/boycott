...
export const translations = {
  ...
  fr: {
    ...
    'whyBoycottParagraph4': 'Il est de notre devoir moral de retirer le soutien économique à ceux qui aident l\'injustice, l\'oppression et les violations des droits humains.',
  ...
  id: {
    ...
    'whyBoycottParagraph1': 'Boikot adalah cara yang kuat untuk menggunakan kekuatan konsumen kita untuk memaksa institusi yang melakukan penyalahgunaan untuk mengubah kebijakan mereka.',
    'whyBoycottSubtitle2': 'Apa Dampaknya?',
    'whyBoycottParagraph2': 'Boikot konsumen kolektif dapat mempengaruhi kesehatan keuangan perusahaan dan membawa perubahan dalam perilaku perusahaan.',
    'whyBoycottSubtitle3': 'Bagaimana Boikot Bekerja?',
    'whyBoycottParagraph3': 'Kita menggunakan kekuatan ekonomi kita dengan tidak membeli produk dan layanan perusahaan dan mendukung alternatif etis.',
    'whyBoycottSubtitle4': 'Mengapa Boikot Ini?',
    'whyBoycottParagraph4': 'Adalah kewajiban moral kita untuk menarik dukungan ekonomi dari mereka yang membantu ketidakadilan, penindasan, dan pelanggaran hak asasi manusia.',
  ...
  tr: {
    ...
    'whyBoycottParagraph1': 'Boykot, tüketici gücümüzü kullanarak istismarcı kurumları politikalarını değiştirmeye zorlamanın güçlü bir yoludur.',
    'whyBoycottSubtitle2': 'Etkisi Nedir?',
    'whyBoycottParagraph2': 'Toplu tüketici boykotları, şirketlerin mali sağlığını etkileyebilir ve kurumsal davranışta değişiklik getirebilir.',
    'whyBoycottSubtitle3': 'Boykot Nasıl Çalışır?',
    'whyBoycottParagraph3': 'Şirketlerin ürün ve hizmetlerini satın almayarak ve etik alternatifleri destekleyerek ekonomik gücümüzü kullanırız.',
    'whyBoycottSubtitle4': 'Neden Bu Boykot?',
    'whyBoycottParagraph4': 'Adaletsizlik, baskı ve insan hakları ihlallerine yardım edenlere ekonomik destek vermemek ahlaki görevimizdir.',
  ...
  ur: {
    ...
    'whyBoycottParagraph1': 'بائیکاٹ ہماری صارفین کی طاقت کا استعمال کرکے ظالم اداروں کو اپنی پالیسیاں تبدیل کرنے پر مجبور کرنے کا ایک طاقتور طریقہ ہے۔',
    'whyBoycottSubtitle2': 'اس کا کیا اثر ہے؟',
    'whyBoycottParagraph2': 'صارفین کے اجتماعی بائیکاٹ کارپوریشنوں کی مالی صحت کو متاثر کر سکتے ہیں اور کارپوریٹ رویے میں تبدیلی لا سکتے ہیں۔',
    'whyBoycottSubtitle3': 'بائیکاٹ کیسے کام کرتا ہے؟',
    'whyBoycottParagraph3': 'ہم کمپنیوں کی مصنوعات اور خدمات نہ خرید کر اور اخلاقی متبادلات کی حمایت کرکے اپنی اقتصادی طاقت کا استعمال کرتے ہیں۔',
    'whyBoycottSubtitle4': 'یہ بائیکاٹ کیوں؟',
    'whyBoycottParagraph4': 'ان لوگوں سے اقتصادی حمایت واپس لینا ہماری اخلاقی ذمہ داری ہے جو ظلم، استحصال، اور انسانی حقوق کی خلاف ورزیوں میں مدد کرتے ہیں۔',
