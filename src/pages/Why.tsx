                ...
                return (
                  <div key={index} className="rounded-lg border p-4 hover:shadow-md">
                    <div className="mb-2 flex items-center gap-2">
                      {IconComponent && <IconComponent className="h-5 w-5 text-yaqiin-800 dark:text-yaqiin-500" />}
                      <h3 className="font-semibold text-yaqiin-800 dark:text-yaqiin-500">{item.title[language]}</h3>
                    </div>
